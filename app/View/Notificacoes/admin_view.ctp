...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Notificacao'), array('action' => 'delete', $notificacao['Notificacao']['id']), array(), __('Are you sure you want to delete # %s?', $notificacao['Notificacao']['id'])); ?> </li>
