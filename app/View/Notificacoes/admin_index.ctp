<div class="notificacoes index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $notificacao['Notificacao']['id']), array(), __('Are you sure you want to delete # %s?', $notificacao['Notificacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
