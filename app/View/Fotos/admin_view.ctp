...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Foto'), array('action' => 'delete', $foto['Foto']['id']), array(), __('Are you sure you want to delete # %s?', $foto['Foto']['id'])); ?> </li>
	...
	<?php foreach ($foto['ChildFoto'] as $childFoto): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'fotos', 'action' => 'delete', $childFoto['id']), array(), __('Are you sure you want to delete # %s?', $childFoto['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
