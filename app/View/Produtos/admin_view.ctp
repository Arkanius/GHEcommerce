	...
	<?php foreach ($produto['ChildProduto'] as $childProduto): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'produtos', 'action' => 'delete', $childProduto['id']), array(), __('Are you sure you want to delete # %s?', $childProduto['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
