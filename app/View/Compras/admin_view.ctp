	...
	<?php foreach ($compra['Notificacao'] as $notificacao): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'notificacoes', 'action' => 'delete', $notificacao['id']), array(), __('Are you sure you want to delete # %s?', $notificacao['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
